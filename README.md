...
### 3. Asegurarce que el repositorio tiene TODOS los archivos de la 

### 4. Revisar que el archivo package.json en la línea ``"ecored-base-pkg": "*.*.*"`` tenga la [última versión]
